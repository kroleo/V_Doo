...
//IN CONSOLE GETTING AN (OS/KERN) INVALID CAPABILITY (20) AND INVALID NAME (15), THIS MAY HAVE SOMETHING TO DO WITH GOOGLE PLIST FILE FROM FIREBASE, WILL INVESTIGATE LATER
